...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed May 16 11:30:42 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/CGViewer1.0.0/ && $(COPY_FILE) --parents main.h gui.h CGMath.h Matrix.h Model.h Scene.h EditWidgets.h Light.h SaveSceneDialog.h Raytracer.h Octree.h MetaVoxel.h SubVoxel.h Voxel.h obj/CGViewer1.0.0/ && $(COPY_FILE) --parents main.cpp gui.cpp Matrix.cpp Model.cpp Scene.cpp EditWidgets.cpp Light.cpp SaveSceneDialog.cpp Raytracer.cpp Octree.cpp Voxel.cpp SubVoxel.cpp obj/CGViewer1.0.0/ && (cd `dirname obj/CGViewer1.0.0` && $(TAR) CGViewer1.0.0.tar CGViewer1.0.0 && $(COMPRESS) CGViewer1.0.0.tar) && $(MOVE) `dirname obj/CGViewer1.0.0`/CGViewer1.0.0.tar.gz . && $(DEL_FILE) -r obj/CGViewer1.0.0
...
obj/SubVoxel.o: SubVoxel.cpp SubVoxel.h \
		MetaVoxel.h \
		CGMath.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/SubVoxel.o SubVoxel.cpp
